          ...
          >
            ...
            <div className="my-8">
              ...
              <UploadButton
                ...
                className="ut-button:bg-blue-600 ut-button:ut-readying:bg-blue-500/50 ut-button:rounded-[1rem] ut-button:bg-gradient-to-b ut-button:from-blue-400 ut-button:to-blue-700 ut-allowed-content:text-white mt-4"
